...
function drawOperatorACLsNEW($operator_id = "") {
    ...
    while ($row = $res->fetchRow()) {
        ...
        echo '<td>';
        printf('<select readonly="readonly" class="form-select" name="ACL_%s">', $file);
        printf('<option value="0" selected>Denied</option>');
        echo '</select>'
           . '</td>'
           . '</tr>';
